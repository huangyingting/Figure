  ...
  return <ProductShell active="/credits"><Page>
    ...
    <section className="mb-7 grid grid-cols-1 overflow-hidden rounded-[18px] border border-line-dark bg-paper shadow-[0_22px_60px_rgb(35_33_27_/_7%)] md:grid-cols-2">
      <div className="grid min-h-[230px] place-items-start content-center bg-[radial-gradient(circle_at_90%_10%,rgb(255_201_77_/_30%),transparent_16rem),var(--color-pine)] p-[34px] text-white">
        <p className="m-0 text-micro font-extrabold uppercase tracking-[0.13em] text-[#cfe8d8]">AVAILABLE BALANCE</p>
        ...
        <small className="mt-6 flex items-center gap-[7px] text-meta text-[#ddeee2]"><Sparkles size={14} /> Each new account begins with 12 credits.</small>
      </div>
      <div className="grid content-center p-[34px]">
        <h2 className="mb-[17px] mt-0 font-display text-[25px] tracking-[-0.015em]">Everything is included.</h2>
    ...
    <section className="overflow-hidden rounded-[14px] border border-line bg-paper">
      ...
      )) : <div className="p-[35px] text-center text-micro text-muted">Your credit activity will appear after your first generation.</div>}
    </section>
  </Page></ProductShell>;
}
